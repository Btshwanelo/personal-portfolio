...
const HeroSection = () => {
  ...
  return (
    <section
      ref={homeRef}
      id='homeContainer'
      className='bg-her w-full mt-15 h-[500px] sm:min-h-[600px] text-center'>
      <div className='w-full bg-hero  h-[500px] sm:min-h-[600px] z-10 flex flex-col justify-center'>
        ...
        <strong className='uppercase mt-6 tracking-wide text-white bounce-top'>and this is My Resume</strong>
      </div>
    </section>
  );
};
